...
Whether using AI coding assistants to generate new code or revise existing code, #TODO

### Identify the relevant styleguide

### Acquire linter configuration files

### Acquire formatter configuration files
...
## Auditing and revising existing code for styleguide compliance
